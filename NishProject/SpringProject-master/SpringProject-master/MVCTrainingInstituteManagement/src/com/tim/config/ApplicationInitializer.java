 ...
 public class ApplicationInitializer implements WebApplicationInitializer {
  ...
  AnnotationConfigWebApplicationContext(); ctx.register(MVCConfig.class);
  ServletRegistration.Dynamic serv=servletContext.addServlet("spring", new
  DispatcherServlet(ctx)); serv.addMapping("/"); serv.setLoadOnStartup(1); }
